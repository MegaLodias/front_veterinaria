...
document.addEventListener('DOMContentLoaded', function() {
    ...
    actualizarBotonInicio(logueado); // Actualiza el enlace del botón "INICIA YA"
...
//CON FEEEEEEEE
function actualizarBotonInicio(logueado) {
    const botonIniciaSesion = document.getElementById('iniciaSesionBtn');

    if (logueado) {
        // Si el usuario está logueado, cambiar el enlace del botón a la página de productos
        botonIniciaSesion.href = "../productos/productos.html";
    } else {
        // Si el usuario no está logueado, mantener el enlace del botón a la página de inicio de sesión
        botonIniciaSesion.href = "../login/login.html";
    }
}
